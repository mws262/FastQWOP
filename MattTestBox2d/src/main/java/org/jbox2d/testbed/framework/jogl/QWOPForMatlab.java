...
public class QWOPForMatlab extends JFrame{
  ...
  public QWOPForMatlab(boolean graphicsFlag) {
...
//	    System.out.println(LThighBody.m_mass);
  ...
  public void StepIt(boolean q, boolean w, boolean o, boolean p){
...
class CheckBoxListener3 implements ItemListener {
	OptionsHolder options;
	public CheckBoxListener3(OptionsHolder options){
		this.options = options;
	}
