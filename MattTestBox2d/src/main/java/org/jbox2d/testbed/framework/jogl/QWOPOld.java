...
public class QWOPOld extends TestbedTest {
  ...
  public QWOPOld(boolean switchBodiesInJoint) {
  ...
  public void initTest(boolean deserialized) {
    ...
    //All bodies declared here:
        ...
        groundShape.set(new Vec2(-100.0f, 0.0f), new Vec2(100.0f, 0.0f));
      ...
      double alpha = Math.atan((kneePos1.y-kneePos2.y)/(kneePos1.x - kneePos2.x));
     ...
     float torsoAng = (float)(-Math.PI/8);
    ...
    ankle1.upperAngle = (float)(0.5);
    ankle1.lowerAngle = (float)(-0.5);
    ...
    ankle2.upperAngle = (float)(0.5);
    ankle2.lowerAngle = (float)(-0.5);
    ...
    knee1.upperAngle = (float)(1.3);
    knee1.lowerAngle = (float)(-0.3);
    ...
    knee2.upperAngle = (float)(1.3);
    knee2.lowerAngle = (float)(-0.3);
    ...
    hipJoint1.upperAngle = (float)(0.7);
    hipJoint1.lowerAngle = (float)(-1.3);
    ...
    hipJoint2.upperAngle = (float)(0.7);
    hipJoint2.lowerAngle = (float)(-1.3);
    ...
    neckJoint.upperAngle = (float)(0.25);
    neckJoint.lowerAngle = (float)(-0.25);
